...
public class Constants {
    ...
    public final static Tile EDGE_TO_BANK_RIDE[] = {new Tile(3086, 3476),new Tile(3089, 3470), new Tile(3092, 3470), new Tile(3094, 3474), new Tile(3089, 3487), new Tile(3092, 3491)};
