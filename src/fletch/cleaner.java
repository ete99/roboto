...
public class cleaner extends PollingScript<ClientContext>  implements PaintListener, MessageListener {
    ...
    public static int LOG_ID = 1515;
    public void start() {
        initime = System.currentTimeMillis();
        taskList.add(new check(ctx));
        taskList.add(new clean(ctx));
        taskList.add(new store(ctx));
...
//        g2.setColor(Color.GREEN);
        ...
        g1.setFont(font);
        g1.drawString("Levels gained : " + levelPlus, 20, 125);
